...
Animation *CREATE_ANIMATION(struct SDL_Renderer *renderer)
{
    ...
    this->ice_1_charge = CREATE_SPRITE("Ice_1_Charge", "graphics/animation/ice_charge_1.png", 1, 10, renderer, 10, generic_hash_strings, 80, 80);
    this->ice_1 = CREATE_SPRITE("Ice_1", "graphics/animation/ice_1.png", 1, 4, renderer, 4, generic_hash_strings, 64, 104);
    return this;
}
